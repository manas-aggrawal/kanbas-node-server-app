...
export default function WorkingWithObjects(app) {
  ...
  app.get("/lab5/module/Desciption/:newDescription", (req, res) => {
  ...
  app.get("/lab5/assignment/score/:newScore", (req, res) => {
    ...
    assignment.score = Number(newScore); // Ensure it's stored as a number
    res.json(assignment);
  });

  // Retrieve current assignment completed status
